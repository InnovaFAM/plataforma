...
resource "aws_iam_role" "role" {
  name               = "v1-innovafam-v1-collabs-certificates-ai-${var.aws_env}"
  description        = "Role v1 collabs certificates ai for ${var.aws_env}"
...
resource "aws_iam_role_policy" "connections_policy" {
  name   = "v1-innovafam-collabs-certificates-ai-${var.aws_env}"
