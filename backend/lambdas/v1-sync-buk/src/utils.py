...
from buk import get_supervisor_name_by_collab_id, get_vacation_balance_by_collab_id
...
def parse_buk_to_fam(buk_collab: BukCollab) -> FAMCollab | None:
    try:
        ...
        if supervisor := get_supervisor_name_by_collab_id(buk_collab.id):
            fam_collab.supervisor = supervisor
