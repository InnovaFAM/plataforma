...
class MockContext:
    def __init__(self):
        self.function_name = "v1-collabs"
        self.memory_limit_in_mb = 128
        self.invoked_function_arn = "arn::v1-collabs"
...
if __name__ == "__main__":
    with open("./tests/events/projects.json", "r") as f:
        # with open("./tests/events/service_detail.json", "r") as f:
        # with open("./tests/events/services.json", "r") as f:
        # with open("./tests/events/collabs.json", "r") as f:
