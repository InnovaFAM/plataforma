...
app.include_router(services_router, "/services")
app.include_router(roles_router, "/services/<service_code>/roles")
app.include_router(
    collabs_router, "/services/<service_code>/roles/<role_hash>/collabs/<collab_id>"
)
