...
const BackOfficeRolesTable = ({
    ...
    const columns: ColumnDef<TBackOfficeRole>[] = useMemo(
        () => [
            {
                header: t('backOffice.rolesTable.name'),
                accessorKey: 'name',
                cell: ({ row }) => (
            ...
            },
            {
                header: (
                    ...
                    | ColumnDefTemplate<HeaderContext<TBackOfficeRole, unknown>>
                    | undefined,
                size: 60,
                id: 'actions',
                cell: ({ row }) => (
        ...
        [t, editMode, setTempRole],
    )

    const renderTable = useMemo(
        () => (
            <DataTable<TBackOfficeRole>
                arrowPagination
                columns={columns}
    ...
    return (
        <div id={id}>
            <h4 className="heading-text text-xl font-bold mb-2">
                {t('backOffice.rolesTable.title')}
            </h4>
            <p className="text-gray-500 mb-4">
                {t('backOffice.rolesTable.description')}
            </p>
            <AdaptiveCard
                footer={{
                    className:
...
export default BackOfficeRolesTable
