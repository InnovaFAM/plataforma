...
const BackOfficeClientsTable = ({
    ...
    const columns: ColumnDef<TBackOfficeClient>[] = useMemo(
        () => [
            { header: t('backOffice.clientsTable.name'), accessorKey: 'name' },
            { header: t('backOffice.clientsTable.rut'), accessorKey: 'rut' },
            {
                header: (
                    <div
                    ...
                    | ColumnDefTemplate<
                          HeaderContext<TBackOfficeClient, unknown>
                      >
                    | undefined,
                size: 60,
                id: 'actions',
        ...
        [t, editMode, setTempClient],
    )

    const renderTable = useMemo(
        () => (
            <DataTable<TBackOfficeClient>
                arrowPagination
    ...
    return (
        <div id={id}>
            <h4 className="heading-text text-xl font-bold mb-2">
                {t('backOffice.clientsTable.title')}
            </h4>
            <p className="text-gray-500 mb-4">
                {t('backOffice.clientsTable.description')}
            </p>
            <AdaptiveCard
                footer={{
                    className:
...
export default BackOfficeClientsTable
