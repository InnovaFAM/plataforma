...
interface CertificationsAffixProps {
    elements: {
        label: string
        id: string
    }[]
...
const CertificationsAffix = ({ elements }: CertificationsAffixProps) => {
    ...
    useEffect(() => {
        if (sectionToScroll) {
            const element = document.getElementById(
                `certifications_${sectionToScroll}`,
            )
            if (element) {
                setTimeout(() => {
...
export default CertificationsAffix
